          ...
          <div style={{ width:"100%", maxWidth:400, background:t.cd, borderRadius:24, padding:28, margin:"auto", animation:"fadeIn 0.2s" }}>
            ...
            <div style={{ marginTop:20, padding:"14px 16px", borderRadius:14, background:t.al, border:"1px solid "+t.bd }}>
              ...
              <div style={{ display:"flex", gap:8 }}>
                <input style={{ ...inp, flex:1, fontSize:16, color:"#000000", background:"#ffffff", letterSpacing:3, fontWeight:700, border:"2px solid "+t.ac }} placeholder="Enter code" value={proCode} onChange={e => setProCode(e.target.value.toUpperCase())} />
        ...
        <div style={{...modBg, alignItems:"center"}} onClick={e => e.target === e.currentTarget && setShowBizUpgrade(false)}>
          <div style={{ width:"100%", maxWidth:400, background:t.cd, borderRadius:24, padding:28, margin:"auto", animation:"fadeIn 0.2s" }}>
            ...
            <div style={{ marginTop:20, padding:"14px 16px", borderRadius:14, background:t.al, border:"1px solid "+t.bd }}>
              ...
              <div style={{ display:"flex", gap:8 }}>
                <input style={{ ...inp, flex:1, fontSize:16, color:"#000000", background:"#ffffff", letterSpacing:3, fontWeight:700, border:"2px solid "+t.ac }} placeholder="Enter code" value={bizCode} onChange={e => setBizCode(e.target.value.toUpperCase())} />
